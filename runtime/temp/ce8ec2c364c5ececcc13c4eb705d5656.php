<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\xampp\htdocs\HRsystem\public/../application/admin\view\index\index.html";i:1561010155;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <link href="/HRsystem/public/static/admin/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden" onload="startTime()">
    ...
    <script src="/HRsystem/public/static/admin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="/HRsystem/public/static/admin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="/HRsystem/public/static/admin/js/plugins/layer/layer.min.js"></script>

    <!-- 自定义js -->
    <script src="/HRsystem/public/static/admin/js/hplus.js?v=4.1.0"></script>
    <script type="text/javascript" src="/HRsystem/public/static/admin/js/contabs.js"></script>

    <!-- 第三方插件 -->
    <script src="/HRsystem/public/static/admin/js/plugins/pace/pace.min.js"></script>
